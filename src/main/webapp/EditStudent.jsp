...
<%
	User user = SchoolApp.userDatabase.get(Integer.parseInt(request.getParameter("id")));
...
<input type="text" name="firstname" placeholder="First Name" value="<%= user.getFirstName() %>" size="15" required />
<label> Last Name </label>    
<input type="text" name="lastname" placeholder="Last Name" value="<%= user.getLastName() %>" size="15"required />   
<label> Middle Name </label>   
<input type="text" name="middlename" placeholder="Middle Name" value="<%= user.getMiddleName() %>" size="15"  />    
...
<label for="email">Email </label>  
 <input type="text" placeholder="Email" value="<%= user.getEmail() %>" name="email" required> 
...
<input type="text" name="phone" placeholder="Phone Number" value="<%= user.getPhoneNo() %>" size="10" required>   
<div>  
...
<textarea name="address" placeholder="Current Address" cols="80" rows="3" required="required"><%out.print(user.getAddress()); %></textarea>  <br> 
