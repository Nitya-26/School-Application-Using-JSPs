...
<body>  
<%
	Teacher user = (HeadMaster) SchoolApp.userDatabase.get(Integer.parseInt(request.getParameter("id")));
	session.setAttribute("user", user);
%>
<form method="post" action="UpdateUsers.jsp">  
  <div class="container">  
    <h1> Head Master Registration Form</h1>  
  <hr> 
...
<label> Subject </label>    
<input type="text" name="subject" placeholder="Enter the Subject" value="<%= user.getSubject() %>" size="15" /> <br>
