...
<title>Head Master Registration</title>
...
<label> Subject </label>    
<input type="text" name="subject" placeholder="Enter the Subject" size="15" /> <br>
